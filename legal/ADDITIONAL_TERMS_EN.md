...
Any redistribution of PayDance source code, object code, or a modified version containing PayDance software code materials must preserve existing copyright notices, license notices, SPDX identifiers, and references to these additional terms.
...
Modified versions must reasonably and clearly state that they have been modified and are not official PayDance releases. The notice may appear in the README, release notes, About view, legal notices, or an equivalent location.
...
This license does not grant trademark rights to use "薪跳", "PayDance", "薪跳 PayDance", the PayDance logo, official icons, official release channels, or other source-identifying marks. Accurate factual references such as "based on PayDance" are permitted.

Modified distributions must use a name and branding clearly distinguishable from the official PayDance product. See [TRADEMARK_EN.md](TRADEMARK_EN.md) and [BRAND-ASSETS_EN.md](BRAND-ASSETS_EN.md) for details.
...
If this file conflicts with AGPL-3.0-only, these terms apply only to the extent permitted by Section 7 of AGPL-3.0-only.
